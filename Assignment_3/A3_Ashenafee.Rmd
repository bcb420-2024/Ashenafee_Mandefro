...
# Rank file should be in the format:
# GeneName	rank
# IGDCC3	36.329579739346
# ANTXR1	35.4794919465309
# AEBP1	    33.1915895022568
# ...       ...
...
rank_file <- file.path(data_dir, "CBD_vs_DMSO_rank.rnk")
...
# Check if the GSEA results were generated
gsea_results <- list.files(gsea_output_dir)
```
