...
```{r export_enrichment_map, eval=TRUE, warning=FALSE, message=FALSE}
...
# TODO: Fix check for if image exists (this checks for wrong thing)
exists(em_image_stringent)

# Display the stringent image
knitr::include_graphics(em_image_stringent)
```

![./output/em_results/CBD_vs_DMSO_stringent_network.png](./output/em_results/CBD_vs_DMSO_stringent_network.png)
...
*Pull images from `output/em_results`*
